...
def geocode_fetch_postalCode(address):
...
#    print(url)
    ...
    #Postal code filter
    postalCodefilter = [y for x in data['results'] for y in x['address_components'] if 'postal_code' in y['types']]
    post_code = postalCodefilter[0]['long_name']
#    print(post_code)
#   output_json = json.dumps(postalCodefilter)
   
#    print(type(output_json))
#    print(data)
#    for item in data['results']:
#      print(item['address_components'])
#   for item in output_json():
#        print(item['long_name'])
    return(post_code) 
zipcode = geocode_fetch_postalCode(test)
print(zipcode)
